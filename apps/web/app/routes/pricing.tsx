...
const plans: Plan[] = [
  ...
  },
  {
    ...
    includes: [
      "Sign in with OAuth",
      "Saved device names",
      "Signed-in devices — start handoffs between your own devices without scanning a QR",
      "Longer sessions",
      "Higher file limits",
...
const compareRows: CompareRow[] = [
  ...
  { feature: "Saved device names", free: "no", account: "yes", pro: "yes" },
  { feature: "Signed-in devices", free: "no", account: "yes", pro: "yes" },
  { feature: "Start handoffs with own devices", free: "no", account: "yes", pro: "yes" },
